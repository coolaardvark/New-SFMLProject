...
# Project file used when building projects with static libs
# Parameters as above for the projectFileTemplate
$global:staticLibProjectFileTemplate = @'
<?xml version="1.0" encoding="utf-8"?>
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <ItemGroup Label="ProjectConfigurations">
    <ProjectConfiguration Include="Debug|Win32">
...
# The rest aren't really templates since we them verbetum.
$global:gitIgnoreTemplate = @'
